        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "ajaxNameCall": {
				 ...
				 "ajax_regemail": {
                    "url": "http://192.168.10.200/lushandcare/jq-ajax/ajax_regemail.php",
                    //"extraData": "name=eric",
				...
				"ajax_logemail": {
                    "url": "http://192.168.10.200/lushandcare/jq-ajax/ajax_logemail.php",
                    //"extraData": "name=eric",
					//"extraDataDynamic": ['#pubid'],					
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
                    "alertTextOk": "* This User email is valid",
				...
				"ajax_pincheck": {
                    "url": "http://192.168.10.200/lushandcare/jq-ajax/ajax_pincheck.php",
                    //"extraData": "name=eric",
					//"extraDataDynamic": ['#pubid'],					
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
				...
				"ajax_track_no": {
                    "url": "http://192.168.10.200/lushandcare/jq-ajax/ajax_track_no.php",
                    //"extraData": "name=eric",
					//"extraDataDynamic": ['#pubid'],					
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
